...
BLACK_STONE = pygame.transform.scale(pygame.image.load(
    "images/BlackGoStone.png"), (WIDTH/5, WIDTH/5))
WHITE_STONE = pygame.transform.scale(pygame.image.load(
    "images/WhiteGoStone.png"), (WIDTH/5, WIDTH/5))
RED_STONE = pygame.transform.scale(pygame.image.load(
    "images/RedGoStone.png"), (WIDTH/5, WIDTH/5))
BlackButton = pygame.transform.scale(pygame.image.load(
    "images/BlackButton.png"), (GUI_WIDTH*.8, GUI_WIDTH*.2))
WhiteButton = pygame.transform.scale(pygame.image.load(
    "images/WhiteButton.png"), (GUI_WIDTH*.8, GUI_WIDTH*.2))
Neutral = pygame.transform.scale(pygame.image.load(
    "images/RedButton.png"), (GUI_WIDTH*.8, GUI_WIDTH*.2))
Remove = pygame.transform.scale(pygame.image.load(
    "images/Remove.png"), (GUI_WIDTH*.8, GUI_WIDTH*.2))
EndTurn = pygame.transform.scale(pygame.image.load(
    "images/EndTurn.png"), (GUI_WIDTH*.8, GUI_WIDTH*.2))
BACKGROUND = pygame.transform.scale(
    pygame.image.load("images/wood.jpg"), (WIDTH, WIDTH))
BLACKWIN = pygame.transform.scale(pygame.image.load(
    "images/BlackWins.png"), (WIDTH*.75, WIDTH*.75))
WHITEWIN = pygame.transform.scale(pygame.image.load(
    "images/WhiteWins.png"), (WIDTH*.75, WIDTH*.75))
OUTOFMOVES = pygame.transform.scale(pygame.image.load(
    "images/OutOfMoves.png"), (WIDTH*.75, WIDTH*.75))
...
def init_buttons():
    ...
    buttons.append(pygame.Rect(GUI_WIDTH/2-GUI_WIDTH*.4,
                   BlackButtonY, GUI_WIDTH*.8, GUI_WIDTH*.2))  # both
    buttons.append(pygame.Rect(GUI_WIDTH/2-GUI_WIDTH*.4,
                   NeutralY, GUI_WIDTH*.8, GUI_WIDTH*.2))  # 3 red
    buttons.append(pygame.Rect(GUI_WIDTH/2-GUI_WIDTH*.4,
                   RemoveY, GUI_WIDTH*.8, GUI_WIDTH*.2))  # remove
    buttons.append(pygame.Rect(GUI_WIDTH/2-GUI_WIDTH*.4,
                   EndTurnY, GUI_WIDTH*.8, GUI_WIDTH*.2))  # end turn
...
def render():
    ...
    if out_of_moves:
        win.blit(OUTOFMOVES, (center_x - OUTOFMOVES.get_width() //
                 2, center_y - OUTOFMOVES.get_height() // 2))
...
def main():
    ...
    while True:
        for event in pygame.event.get():
            if event.type == pygame.MOUSEBUTTONDOWN:
                pygame.quit()
        win.blit(winImage, (center_x - winImage.get_width() //
                 2, center_y - winImage.get_height() // 2))
        pygame.display.update()
